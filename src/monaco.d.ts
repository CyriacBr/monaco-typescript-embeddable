declare module monaco.languages.typescript {
  ...
  export var Embeddable: {
    setup(myLang: string): void;
    setMakeModelContent(func: (model: monaco.editor.IReadOnlyModel) => string): void;
  };
  export var setupEmbedded: (myLang: string) => void;
}
